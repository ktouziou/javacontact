...
public class ContactMobilApp {


    final static Scanner in = new Scanner(System.in);

    //pinakas me 500 grammes 3 sthles
    final static String[][] contacts = new String[500][3];

    //deiktis pou koita eggrafes
    static int pivot = -1;


    //gia na grafoume
    final static Path path = Paths.get("C:/tempp/log-mobile.txt");
    ...
    public static boolean insert(String firstname, String lastname, String phoneNumber) {
        ...
        if (getIndexByPhoneNumber(phoneNumber) != -1) {   // an uparxei idi
            return false;
        }
    ...
    public static boolean update(String oldPhoneNumber, String firstname, String lastname, String newPhoneNumber) {
        // public String[] boolean update(String oldPhoneNumber, String firstname, String lastname, String newPhoneNumber) {
        int positionToUpdate = getIndexByPhoneNumber(oldPhoneNumber);
        String[] contact = new String[3];

        if (positionToUpdate == -1) {   //den vre8ike
            return false;
            // return new String[] {};
        }
...
//        contact[2] = contacts[positionToUpdate][2];
    ...
    public static String[] delete(String phoneNumber) {
        ...
        //} return contact;
        //=
        // antigrafei ton pinaka apo tin 8esi pou diagrapsame
        System.arraycopy(contacts[positionToDelete], 0, contact, 0, contact.length);

        //elegxei an den einai to teleutaio stoixeio na metaferi ton pivot mia 8esi dexia
     ...
     * log(Exception)
     */
//... varargs-->8elei pinaka gia na perasw 1 string, 2 string.. i kanena(parametrous)
    public static void log(Exception e, String... message) {
        try (PrintStream ps = new PrintStream(new FileOutputStream(path.toFile(), true))) {
            //pote sunevei?
            ps.println(LocalDateTime.now() + "\n" + e.toString());
            //munima an einai ena fere to 0 alliws tipota
